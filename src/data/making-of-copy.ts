export const makingOfPassages = [
  ...
  `现在我有了一个可供大家访问、查阅的个人主页，我把各种老的作品、新的心思放进了这里。它的诞生可能没有太多目的性——只是在“想造出一个能用符合我个人趣味的方式展示我过往经历的东西”这样的念头下被完成了——因而现如今的我，已经能为此而心满意足，即便AI只给我送来一双简陋的翅膀，我最终也还是靠着它，完成了这场笨拙的飞行。`,
